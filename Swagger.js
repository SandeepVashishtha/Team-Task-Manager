...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'REST API for Team Task Manager — Authentication, Projects, Tasks, Dashboard with Role-Based Access Control',
      contact: { name: 'API Support' },
    },
    servers: [
      { url: 'http://localhost:5000/api', description: 'Development' },
      { url: 'https://your-app.railway.app/api', description: 'Production (Railway)' },
    ],
    components: {
      securitySchemes: {
        BearerAuth: {
